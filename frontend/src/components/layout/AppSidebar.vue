...
<template>
  <aside
    :class="[
      'fixed inset-y-0 left-0 z-50 flex w-64 flex-col bg-white border-r border-gray-200 transition-transform lg:translate-x-0',
  ...
  >
    ...
    <div class="flex h-16 items-center gap-3 border-b border-gray-200 px-6">
      ...
      <span class="text-lg font-semibold text-gray-900">Fleet MS</span>
    </div>
...
<script lang="ts">
// Simple SVG icon component for sidebar (avoids external icon library dependency)
