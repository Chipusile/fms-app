  ...
  <div class="space-y-6">
    ...
    <div class="grid gap-4 md:grid-cols-3">
      <div class="rounded-2xl border border-slate-200 bg-white/90 p-5 shadow-sm shadow-slate-200/60">
        <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Tracked schedules</p>
        <p class="mt-3 text-3xl font-semibold text-slate-950">{{ meta.total }}</p>
        <p class="mt-2 text-sm text-slate-600">Tenant-wide maintenance plans currently available in the registry.</p>
      </div>
      <div class="rounded-2xl border border-amber-200 bg-amber-50/70 p-5 shadow-sm shadow-amber-100/60">
        ...
        <p class="mt-3 text-3xl font-semibold text-amber-950">{{ upcomingSchedules.length }}</p>
      ...
      <div class="rounded-2xl border border-rose-200 bg-rose-50/70 p-5 shadow-sm shadow-rose-100/60">
        <p class="text-xs font-semibold uppercase tracking-[0.18em] text-rose-700">Overdue</p>
        <p class="mt-3 text-3xl font-semibold text-rose-950">{{ overdueSchedules.length }}</p>
